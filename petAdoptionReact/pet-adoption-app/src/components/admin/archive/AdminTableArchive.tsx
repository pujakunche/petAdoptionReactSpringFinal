...
interface AdminTableArchiveProps {
...
function AdminTableArchive({ selectedPetId, setSelectedPet, allPets, setAllPets}: AdminTableArchiveProps) {
...
export default AdminTableArchive